...
with st.form('page_form'):
    ...
    if submitted:
        ...
        #     with col1:
        #         st.page_link("personality-quiz/00_start_page.py", label="Prev Page!", use_container_width=True)
        #
        #     with col2:
        #         st.page_link("personality-quiz/02_question_page2.py", label="Next Page!", use_container_width=True)
