...
page_handler.get_questions('personality_quiz/questions4_during_games_social.txt')
...
st.page_link("personality_quiz/results_page.py", label="Calculate My Results!")
